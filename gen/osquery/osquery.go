...
func (p *ExtensionManagerClient) StreamEvents(ctx context.Context, name string, events ExtensionPluginResponse) (r *ExtensionStatus, err error) {
  var _args33 ExtensionManagerStreamEventsArgs
  _args33.Name = name
  _args33.Events = events
  var _result34 ExtensionManagerStreamEventsResult
  if err = p.Client_().Call(ctx, "streamEvents", &_args33, &_result34); err != nil {
    return
  }
...
func NewExtensionManagerProcessor(handler ExtensionManager) *ExtensionManagerProcessor {
  self35 := &ExtensionManagerProcessor{NewExtensionProcessor(handler)}
  self35.AddToProcessorMap("extensions", &extensionManagerProcessorExtensions{handler:handler})
  self35.AddToProcessorMap("options", &extensionManagerProcessorOptions{handler:handler})
  self35.AddToProcessorMap("registerExtension", &extensionManagerProcessorRegisterExtension{handler:handler})
  self35.AddToProcessorMap("deregisterExtension", &extensionManagerProcessorDeregisterExtension{handler:handler})
  self35.AddToProcessorMap("query", &extensionManagerProcessorQuery{handler:handler})
  self35.AddToProcessorMap("getQueryColumns", &extensionManagerProcessorGetQueryColumns{handler:handler})
  self35.AddToProcessorMap("streamEvents", &extensionManagerProcessorStreamEvents{handler:handler})
  return self35
}
...
func (p *extensionManagerProcessorStreamEvents) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
    oprot.WriteMessageBegin("streamEvents", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush(ctx)
    return false, err
...
var retval *ExtensionStatus
  ...
  if err2 = oprot.WriteMessageBegin("streamEvents", thrift.REPLY, seqId); err2 != nil {
    err = err2
  }
  if err2 = result.Write(oprot); err == nil && err2 != nil {
    err = err2
...
func (p *ExtensionManagerStreamEventsArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *ExtensionManagerStreamEventsArgs)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.Name = v
...
func (p *ExtensionManagerStreamEventsArgs)  ReadField2(iprot thrift.TProtocol) error {
  _, size, err := iprot.ReadListBegin()
  if err != nil {
    return thrift.PrependError("error reading list begin: ", err)
  }
...
var _val49 string
    ...
    p.Events = append(p.Events, _elem47)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ExtensionManagerStreamEventsArgs) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("streamEvents_args"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
    if err := p.writeField2(oprot); err != nil { return err }
...
func (p *ExtensionManagerStreamEventsArgs) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("name", thrift.STRING, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:name: ", p), err) }
  if err := oprot.WriteString(string(p.Name)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.name (1) field write error: ", p), err) }
...
func (p *ExtensionManagerStreamEventsArgs) writeField2(oprot thrift.TProtocol) (err error) {
  ...
  if err := oprot.WriteListBegin(thrift.MAP, len(p.Events)); err != nil {
    return thrift.PrependError("error writing list begin: ", err)
  }
...
func (p *ExtensionManagerStreamEventsResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *ExtensionManagerStreamEventsResult)  ReadField0(iprot thrift.TProtocol) error {
  p.Success = &ExtensionStatus{}
  if err := p.Success.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
  }
...
func (p *ExtensionManagerStreamEventsResult) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("streamEvents_result"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField0(oprot); err != nil { return err }
  }
...
func (p *ExtensionManagerStreamEventsResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := p.Success.Write(oprot); err != nil {
