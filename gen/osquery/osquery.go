...
func (p *ExtensionClient) Ping(ctx context.Context) (r *ExtensionStatus, err error) {
	...
	var _result6 ExtensionPingResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "ping", &_args5, &_result6)
...
func (p *ExtensionClient) Call(ctx context.Context, registry string, item string, request ExtensionPluginRequest) (r *ExtensionResponse, err error) {
	var _args7 ExtensionCallArgs
	_args7.Registry = registry
	_args7.Item = item
	_args7.Request = request
	var _result8 ExtensionCallResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "call", &_args7, &_result8)
	p.SetLastResponseMeta_(meta)
	if err != nil {
		return
	}
...
func (p *ExtensionClient) Shutdown(ctx context.Context) (err error) {
	var _args9 ExtensionShutdownArgs
	var _result10 ExtensionShutdownResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "shutdown", &_args9, &_result10)
	p.SetLastResponseMeta_(meta)
	if err != nil {
		return
	}
...
func NewExtensionProcessor(handler Extension) *ExtensionProcessor {
	...
	self11 := &ExtensionProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self11.processorMap["ping"] = &extensionProcessorPing{handler: handler}
	self11.processorMap["call"] = &extensionProcessorCall{handler: handler}
	self11.processorMap["shutdown"] = &extensionProcessorShutdown{handler: handler}
	return self11
}
...
func (p *ExtensionManagerClient) Extensions(ctx context.Context) (r InternalExtensionList, err error) {
	var _args23 ExtensionManagerExtensionsArgs
	var _result24 ExtensionManagerExtensionsResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "extensions", &_args23, &_result24)
	p.SetLastResponseMeta_(meta)
	if err != nil {
		return
	}
...
func (p *ExtensionManagerClient) Options(ctx context.Context) (r InternalOptionList, err error) {
	var _args25 ExtensionManagerOptionsArgs
	var _result26 ExtensionManagerOptionsResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "options", &_args25, &_result26)
	p.SetLastResponseMeta_(meta)
	if err != nil {
		return
	}
...
func (p *ExtensionManagerClient) RegisterExtension(ctx context.Context, info *InternalExtensionInfo, registry ExtensionRegistry) (r *ExtensionStatus, err error) {
	var _args27 ExtensionManagerRegisterExtensionArgs
	_args27.Info = info
	_args27.Registry = registry
	var _result28 ExtensionManagerRegisterExtensionResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "registerExtension", &_args27, &_result28)
	p.SetLastResponseMeta_(meta)
	if err != nil {
		return
	}
...
func (p *ExtensionManagerClient) DeregisterExtension(ctx context.Context, uuid ExtensionRouteUUID) (r *ExtensionStatus, err error) {
	var _args29 ExtensionManagerDeregisterExtensionArgs
	_args29.UUID = uuid
	var _result30 ExtensionManagerDeregisterExtensionResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "deregisterExtension", &_args29, &_result30)
	p.SetLastResponseMeta_(meta)
	if err != nil {
		return
	}
...
func (p *ExtensionManagerClient) Query(ctx context.Context, sql string) (r *ExtensionResponse, err error) {
	var _args31 ExtensionManagerQueryArgs
	_args31.Sql = sql
	var _result32 ExtensionManagerQueryResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "query", &_args31, &_result32)
	p.SetLastResponseMeta_(meta)
	if err != nil {
		return
	}
...
func (p *ExtensionManagerClient) GetQueryColumns(ctx context.Context, sql string) (r *ExtensionResponse, err error) {
	var _args33 ExtensionManagerGetQueryColumnsArgs
	_args33.Sql = sql
	var _result34 ExtensionManagerGetQueryColumnsResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "getQueryColumns", &_args33, &_result34)
	p.SetLastResponseMeta_(meta)
	if err != nil {
		return
	}
...
//  - Name
//  - Events
func (p *ExtensionManagerClient) StreamEvents(ctx context.Context, name string, events ExtensionPluginResponse) (r *ExtensionStatus, err error) {
	var _args35 ExtensionManagerStreamEventsArgs
	_args35.Name = name
	_args35.Events = events
	var _result36 ExtensionManagerStreamEventsResult
	var meta thrift.ResponseMeta
	meta, err = p.Client_().Call(ctx, "streamEvents", &_args35, &_result36)
	p.SetLastResponseMeta_(meta)
	if err != nil {
		return
	}
