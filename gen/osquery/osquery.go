...
func (p *ExtensionClient) Call(ctx context.Context, registry string, item string, request ExtensionPluginRequest) (_r *ExtensionResponse, _err error) {
	var _args8 ExtensionCallArgs
	_args8.Registry = registry
	_args8.Item = item
	_args8.Request = request
	var _result10 ExtensionCallResult
	var _meta9 thrift.ResponseMeta
	_meta9, _err = p.Client_().Call(ctx, "call", &_args8, &_result10)
...
func (p *ExtensionClient) Shutdown(ctx context.Context) (_err error) {
	var _args11 ExtensionShutdownArgs
	var _result13 ExtensionShutdownResult
	var _meta12 thrift.ResponseMeta
	_meta12, _err = p.Client_().Call(ctx, "shutdown", &_args11, &_result13)
...
func NewExtensionProcessor(handler Extension) *ExtensionProcessor {
	...
	self14 := &ExtensionProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self14.processorMap["ping"] = &extensionProcessorPing{handler: handler}
	self14.processorMap["call"] = &extensionProcessorCall{handler: handler}
	self14.processorMap["shutdown"] = &extensionProcessorShutdown{handler: handler}
	return self14
}
...
type ExtensionManager interface {
	...
	//  - Name
	//  - Events
	StreamEvents(ctx context.Context, name string, events ExtensionPluginResponse) (_r *ExtensionStatus, _err error)
	GetNodeKey(ctx context.Context) (_r string, _err error)
}
...
func (p *ExtensionManagerClient) Extensions(ctx context.Context) (_r InternalExtensionList, _err error) {
	var _args26 ExtensionManagerExtensionsArgs
	var _result28 ExtensionManagerExtensionsResult
	var _meta27 thrift.ResponseMeta
	_meta27, _err = p.Client_().Call(ctx, "extensions", &_args26, &_result28)
...
func (p *ExtensionManagerClient) Options(ctx context.Context) (_r InternalOptionList, _err error) {
	var _args29 ExtensionManagerOptionsArgs
	var _result31 ExtensionManagerOptionsResult
	var _meta30 thrift.ResponseMeta
	_meta30, _err = p.Client_().Call(ctx, "options", &_args29, &_result31)
...
func (p *ExtensionManagerClient) RegisterExtension(ctx context.Context, info *InternalExtensionInfo, registry ExtensionRegistry) (_r *ExtensionStatus, _err error) {
	var _args32 ExtensionManagerRegisterExtensionArgs
	_args32.Info = info
	_args32.Registry = registry
	var _result34 ExtensionManagerRegisterExtensionResult
	var _meta33 thrift.ResponseMeta
	_meta33, _err = p.Client_().Call(ctx, "registerExtension", &_args32, &_result34)
...
func (p *ExtensionManagerClient) DeregisterExtension(ctx context.Context, uuid ExtensionRouteUUID) (_r *ExtensionStatus, _err error) {
	var _args35 ExtensionManagerDeregisterExtensionArgs
	_args35.UUID = uuid
	var _result37 ExtensionManagerDeregisterExtensionResult
	var _meta36 thrift.ResponseMeta
	_meta36, _err = p.Client_().Call(ctx, "deregisterExtension", &_args35, &_result37)
...
func (p *ExtensionManagerClient) Query(ctx context.Context, sql string) (_r *ExtensionResponse, _err error) {
	var _args38 ExtensionManagerQueryArgs
	_args38.Sql = sql
	var _result40 ExtensionManagerQueryResult
	var _meta39 thrift.ResponseMeta
	_meta39, _err = p.Client_().Call(ctx, "query", &_args38, &_result40)
...
func (p *ExtensionManagerClient) GetQueryColumns(ctx context.Context, sql string) (_r *ExtensionResponse, _err error) {
	var _args41 ExtensionManagerGetQueryColumnsArgs
	_args41.Sql = sql
	var _result43 ExtensionManagerGetQueryColumnsResult
	var _meta42 thrift.ResponseMeta
	_meta42, _err = p.Client_().Call(ctx, "getQueryColumns", &_args41, &_result43)
...
//  - Name
//  - Events
func (p *ExtensionManagerClient) StreamEvents(ctx context.Context, name string, events ExtensionPluginResponse) (_r *ExtensionStatus, _err error) {
	var _args44 ExtensionManagerStreamEventsArgs
	_args44.Name = name
	_args44.Events = events
	var _result46 ExtensionManagerStreamEventsResult
	var _meta45 thrift.ResponseMeta
	_meta45, _err = p.Client_().Call(ctx, "streamEvents", &_args44, &_result46)
...
func (p *ExtensionManagerClient) GetNodeKey(ctx context.Context) (_r string, _err error) {
	var _args47 ExtensionManagerGetNodeKeyArgs
	var _result49 ExtensionManagerGetNodeKeyResult
	var _meta48 thrift.ResponseMeta
	_meta48, _err = p.Client_().Call(ctx, "getNodeKey", &_args47, &_result49)
...
func NewExtensionManagerProcessor(handler ExtensionManager) *ExtensionManagerProcessor {
	...
	self50.AddToProcessorMap("streamEvents", &extensionManagerProcessorStreamEvents{handler: handler})
	self50.AddToProcessorMap("getNodeKey", &extensionManagerProcessorGetNodeKey{handler: handler})
	return self50
}
...
type extensionManagerProcessorStreamEvents struct {
	handler ExtensionManager
}

func (p *extensionManagerProcessorStreamEvents) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := ExtensionManagerStreamEventsArgs{}
	var err2 error
	if err2 = args.Read(ctx, iprot); err2 != nil {
		iprot.ReadMessageEnd(ctx)
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err2.Error())
		oprot.WriteMessageBegin(ctx, "streamEvents", thrift.EXCEPTION, seqId)
		x.Write(ctx, oprot)
		oprot.WriteMessageEnd(ctx)
		oprot.Flush(ctx)
		return false, thrift.WrapTException(err2)
	...
	result := ExtensionManagerStreamEventsResult{}
	var retval *ExtensionStatus
	if retval, err2 = p.handler.StreamEvents(ctx, args.Name, args.Events); err2 != nil {
		tickerCancel()
		if err2 == thrift.ErrAbandonRequest {
			return false, thrift.WrapTException(err2)
		}
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing streamEvents: "+err2.Error())
		oprot.WriteMessageBegin(ctx, "streamEvents", thrift.EXCEPTION, seqId)
		x.Write(ctx, oprot)
		oprot.WriteMessageEnd(ctx)
		oprot.Flush(ctx)
	...
	tickerCancel()
	if err2 = oprot.WriteMessageBegin(ctx, "streamEvents", thrift.REPLY, seqId); err2 != nil {
		err = thrift.WrapTException(err2)
	}
	if err2 = result.Write(ctx, oprot); err == nil && err2 != nil {
		err = thrift.WrapTException(err2)
...
//  - Name
//  - Events
type ExtensionManagerStreamEventsArgs struct {
	Name   string                  `thrift:"name,1" db:"name" json:"name"`
	Events ExtensionPluginResponse `thrift:"events,2" db:"events" json:"events"`
}

func NewExtensionManagerStreamEventsArgs() *ExtensionManagerStreamEventsArgs {
	return &ExtensionManagerStreamEventsArgs{}
}

func (p *ExtensionManagerStreamEventsArgs) GetName() string {
	return p.Name
}

func (p *ExtensionManagerStreamEventsArgs) GetEvents() ExtensionPluginResponse {
	return p.Events
}
func (p *ExtensionManagerStreamEventsArgs) Read(ctx context.Context, iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(ctx); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *ExtensionManagerStreamEventsArgs) ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(ctx); err != nil {
		return thrift.PrependError("error reading field 1: ", err)
	} else {
		p.Name = v
...
func (p *ExtensionManagerStreamEventsArgs) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin(ctx)
	if err != nil {
		return thrift.PrependError("error reading list begin: ", err)
	}
	...
	for i := 0; i < size; i++ {
		...
		p.Events = append(p.Events, _elem62)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *ExtensionManagerStreamEventsArgs) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "streamEvents_args"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField1(ctx, oprot); err != nil {
...
func (p *ExtensionManagerStreamEventsArgs) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin(ctx, "name", thrift.STRING, 1); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:name: ", p), err)
	}
	if err := oprot.WriteString(ctx, string(p.Name)); err != nil {
...
func (p *ExtensionManagerStreamEventsArgs) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin(ctx, "events", thrift.LIST, 2); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:events: ", p), err)
	}
	if err := oprot.WriteListBegin(ctx, thrift.MAP, len(p.Events)); err != nil {
		return thrift.PrependError("error writing list begin: ", err)
	}
	...
	if err := oprot.WriteFieldEnd(ctx); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 2:events: ", p), err)
	}
	return err
}

func (p *ExtensionManagerStreamEventsArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ExtensionManagerStreamEventsArgs(%+v)", *p)
}

// Attributes:
//  - Success
type ExtensionManagerStreamEventsResult struct {
	Success *ExtensionStatus `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewExtensionManagerStreamEventsResult() *ExtensionManagerStreamEventsResult {
	return &ExtensionManagerStreamEventsResult{}
}

var ExtensionManagerStreamEventsResult_Success_DEFAULT *ExtensionStatus

func (p *ExtensionManagerStreamEventsResult) GetSuccess() *ExtensionStatus {
	if !p.IsSetSuccess() {
		return ExtensionManagerStreamEventsResult_Success_DEFAULT
	}
	return p.Success
}
func (p *ExtensionManagerStreamEventsResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ExtensionManagerStreamEventsResult) Read(ctx context.Context, iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(ctx); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *ExtensionManagerStreamEventsResult) ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
	p.Success = &ExtensionStatus{}
	if err := p.Success.Read(ctx, iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
	}
...
func (p *ExtensionManagerStreamEventsResult) Write(ctx context.Context, oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin(ctx, "streamEvents_result"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField0(ctx, oprot); err != nil {
...
func (p *ExtensionManagerStreamEventsResult) writeField0(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err := oprot.WriteFieldBegin(ctx, "success", thrift.STRUCT, 0); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err)
		}
...
func (p *ExtensionManagerStreamEventsResult) String() string {
	if p == nil {
		return "<nil>"
	}
